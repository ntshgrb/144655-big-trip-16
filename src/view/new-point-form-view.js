...
const createEventOffers = (offers) => {
  ...
  const availableOffers = ['<h3 class="event__section-title  event__section-title--offers">Offers</h3><div class="event__available-offers">'].concat(eventOffers, ['</div>']);

  return availableOffers.join('');
};

const createPhotos = (information) => {
  if (!information.photos) {
    return '';
  }
